...
/** Lazy view of `yieldyak_staked_avax.types.v1.Events`: nested and repeated message fields are
...
/** Lazy view of `yieldyak_staked_avax.types.v1.GavaxTransferSingle`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
...
/** Lazy view of `yieldyak_staked_avax.types.v1.GavaxTransferBatch`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
