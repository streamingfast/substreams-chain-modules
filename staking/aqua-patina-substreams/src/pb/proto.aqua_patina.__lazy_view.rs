...
/** Lazy view of `aqua_patina.types.v1.Events`: nested and repeated message fields are
...
pub struct EventsLazyView<'a> {
    ...
    pub apeth_transfers: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::ApethTransferLazyView<'a>,
    >,
    /// Field 2: `apeth_early_deposits_minteds`
    pub apeth_early_deposits_minteds: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::ApethEarlyDepositsMintedLazyView<'a>,
    >,
}
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                1u32 => {
                    ...
                    view.apeth_transfers.push_bytes(sub, __sub_ctx);
                }
                2u32 => {
                    ::buffa::encoding::check_wire_type(
                        tag,
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    ctx.register_element_memory(::core::mem::size_of::<&'a [u8]>())?;
                    view.apeth_early_deposits_minteds.push_bytes(sub, __sub_ctx);
                }
                _ => {
        ...
        ::core::result::Result::Ok(super::super::Events {
            apeth_transfers: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.apeth_transfers.len(),
                );
                for __r in self.apeth_transfers.iter() {
            ...
            apeth_early_deposits_minteds: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.apeth_early_deposits_minteds.len(),
                );
                for __r in self.apeth_early_deposits_minteds.iter() {
                    __out.push(__r?.to_owned_message()?);
                }
                __out
            },
...
impl<'a> EventsLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        let mut size = 0u64;
        for __frag in self.apeth_transfers.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
        for __frag in self.apeth_early_deposits_minteds.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
...
/** Lazy view of `aqua_patina.types.v1.ApethTransfer`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `ApethTransferView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `ApethTransferView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = ApethTransferLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct ApethTransferLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `from`
    pub from: &'a str,
...
impl<'a> ApethTransferLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for ApethTransferLazyView<'a> {
...
impl<'a> ::buffa::MessageName for ApethTransferLazyView<'a> {
    const PACKAGE: &'static str = "aqua_patina.types.v1";
...
/** Lazy view of `aqua_patina.types.v1.ApethEarlyDepositsMinted`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `ApethEarlyDepositsMintedView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `ApethEarlyDepositsMintedView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = ApethEarlyDepositsMintedLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct ApethEarlyDepositsMintedLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `recipient`
    pub recipient: &'a str,
...
impl<'a> ApethEarlyDepositsMintedLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for ApethEarlyDepositsMintedLazyView<'a> {
...
impl<'a> ::buffa::MessageName for ApethEarlyDepositsMintedLazyView<'a> {
    const PACKAGE: &'static str = "aqua_patina.types.v1";
