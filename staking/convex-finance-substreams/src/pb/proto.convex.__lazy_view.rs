...
/** Lazy view of `convex.types.v1.Events`: nested and repeated message fields are
...
pub struct EventsLazyView<'a> {
    /// Field 1: `deposited`
    pub deposited: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::DepositedLazyView<'a>,
    >,
    /// Field 2: `withdrawn`
    pub withdrawn: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::WithdrawnLazyView<'a>,
    >,
}
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                1u32 => {
                    ...
                    view.deposited.push_bytes(sub, __sub_ctx);
                }
                2u32 => {
                    ::buffa::encoding::check_wire_type(
                        tag,
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    ctx.register_element_memory(::core::mem::size_of::<&'a [u8]>())?;
                    view.withdrawn.push_bytes(sub, __sub_ctx);
                }
                _ => {
    ...
    fn to_owned_message(
        ...
        ::core::result::Result::Ok(super::super::Events {
            deposited: {
                ...
                for __r in self.deposited.iter() {
            ...
            withdrawn: {
                ...
                for __r in self.withdrawn.iter() {
                    __out.push(__r?.to_owned_message()?);
                }
                __out
            },
...
impl<'a> EventsLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        let mut size = 0u64;
        for __frag in self.deposited.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
        for __frag in self.withdrawn.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
...
/** Lazy view of `convex.types.v1.Deposited`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `DepositedView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `DepositedView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = DepositedLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct DepositedLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `user`
    pub user: &'a str,
...
impl<'a> ::buffa::LazyMessageView<'a> for DepositedLazyView<'a> {
...
impl<'a> ::buffa::MessageName for DepositedLazyView<'a> {
    const PACKAGE: &'static str = "convex.types.v1";
...
/** Lazy view of `convex.types.v1.Withdrawn`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `WithdrawnView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `WithdrawnView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = WithdrawnLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct WithdrawnLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `user`
    pub user: &'a str,
...
impl<'a> ::buffa::LazyMessageView<'a> for WithdrawnLazyView<'a> {
...
impl<'a> ::buffa::MessageName for WithdrawnLazyView<'a> {
    const PACKAGE: &'static str = "convex.types.v1";
