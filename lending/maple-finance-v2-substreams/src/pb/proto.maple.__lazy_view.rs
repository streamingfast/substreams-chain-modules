...
/** Lazy view of `maple.types.v1.Events`: nested and repeated message fields are
...
pub struct EventsLazyView<'a> {
    ...
    pub instances_deployed: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::InstanceDeployedLazyView<'a>,
    >,
    /// Field 2: `loans_added_to_transition`
    pub loans_added_to_transition: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::LoanAddedToTransitionLoanManagerLazyView<'a>,
    >,
}
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                1u32 => {
                    ...
                    view.instances_deployed.push_bytes(sub, __sub_ctx);
                }
                2u32 => {
                    ::buffa::encoding::check_wire_type(
                        tag,
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    ctx.register_element_memory(::core::mem::size_of::<&'a [u8]>())?;
                    view.loans_added_to_transition.push_bytes(sub, __sub_ctx);
                }
                _ => {
        ...
        ::core::result::Result::Ok(super::super::Events {
            instances_deployed: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.instances_deployed.len(),
                );
                for __r in self.instances_deployed.iter() {
            ...
            loans_added_to_transition: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.loans_added_to_transition.len(),
                );
                for __r in self.loans_added_to_transition.iter() {
                    __out.push(__r?.to_owned_message()?);
                }
                __out
            },
...
impl<'a> EventsLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        let mut size = 0u64;
        for __frag in self.instances_deployed.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
        for __frag in self.loans_added_to_transition.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
...
/** Lazy view of `maple.types.v1.InstanceDeployed`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `InstanceDeployedView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `InstanceDeployedView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = InstanceDeployedLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct InstanceDeployedLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `version`
    pub version: &'a str,
...
impl<'a> InstanceDeployedLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for InstanceDeployedLazyView<'a> {
...
impl<'a> ::buffa::MessageName for InstanceDeployedLazyView<'a> {
    const PACKAGE: &'static str = "maple.types.v1";
...
/** Lazy view of `maple.types.v1.LoanAddedToTransitionLoanManager`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `LoanAddedToTransitionLoanManagerView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `LoanAddedToTransitionLoanManagerView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = LoanAddedToTransitionLoanManagerLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct LoanAddedToTransitionLoanManagerLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
...
impl<'a> LoanAddedToTransitionLoanManagerLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for LoanAddedToTransitionLoanManagerLazyView<'a> {
...
impl<'a> ::buffa::MessageName for LoanAddedToTransitionLoanManagerLazyView<'a> {
    const PACKAGE: &'static str = "maple.types.v1";
