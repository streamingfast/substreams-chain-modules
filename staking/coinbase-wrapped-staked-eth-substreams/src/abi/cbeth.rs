...
pub mod functions {
    ...
    impl Allowance {
        ...
        pub fn decode(
            ...
            Ok(Self {
                ...
                spender: substreams_ethereum::abi::read_address(data, 32, "spender")?,
            })
        }
    ...
    impl Approve {
        ...
        pub fn decode(
            ...
            let data = maybe_data.unwrap();
            Ok(Self {
                spender: substreams_ethereum::abi::read_address(data, 0, "spender")?,
                value: substreams_ethereum::abi::read_uint(data, 32, "value")?,
            })
        }
        pub fn encode(&self) -> Vec<u8> {
            let mut out: Vec<u8> = Vec::with_capacity(4 + 64usize);
            ...
            substreams_ethereum::abi::write_uint_at(&mut out, base + 32, &self.value);
            out
        }
        pub fn output_call(
            call: &substreams_ethereum::pb::eth::v2::Call,
    ...
    impl AuthorizationState {
        ...
        pub fn decode(
            ...
            Ok(Self {
                ...
                nonce: substreams_ethereum::abi::read_fixed_bytes::<
                    32,
                >(data, 32, "nonce")?,
            })
        }
        ...
        pub fn decode(
            ...
            Ok(Self {
                ...
                nonce: substreams_ethereum::abi::read_fixed_bytes::<
                    32,
                >(data, 32, "nonce")?,
                v: substreams_ethereum::abi::read_uint(data, 64, "v")?,
                r: substreams_ethereum::abi::read_fixed_bytes::<32>(data, 96, "r")?,
                s: substreams_ethereum::abi::read_fixed_bytes::<32>(data, 128, "s")?,
            })
        }
        pub fn encode(&self) -> Vec<u8> {
            ...
            substreams_ethereum::abi::write_uint_at(&mut out, base + 64, &self.v);
            substreams_ethereum::abi::write_fixed_bytes_at(
                &mut out,
                base + 96,
                self.r.as_ref(),
    ...
    impl ConfigureMinter {
        ...
        pub fn decode(
            ...
            let data = maybe_data.unwrap();
            Ok(Self {
                minter: substreams_ethereum::abi::read_address(data, 0, "minter")?,
                minter_allowed_amount: substreams_ethereum::abi::read_uint(
                    data,
                    32,
        ...
        pub fn encode(&self) -> Vec<u8> {
            ...
            out.extend(Self::METHOD_ID);
            let base = substreams_ethereum::abi::reserve_head(&mut out, 64usize);
            substreams_ethereum::abi::write_address_at(&mut out, base + 0, &self.minter);
            substreams_ethereum::abi::write_uint_at(
                &mut out,
                base + 32,
                &self.minter_allowed_amount,
            );
            out
        }
        pub fn output_call(
    ...
    impl DecreaseAllowance {
        ...
        pub fn decode(
            ...
            Ok(Self {
                spender: substreams_ethereum::abi::read_address(data, 0, "spender")?,
                decrement: substreams_ethereum::abi::read_uint(data, 32, "decrement")?,
            })
        }
        pub fn encode(&self) -> Vec<u8> {
            let mut out: Vec<u8> = Vec::with_capacity(4 + 64usize);
    ...
    impl IncreaseAllowance {
        ...
        pub fn decode(
            ...
            Ok(Self {
                spender: substreams_ethereum::abi::read_address(data, 0, "spender")?,
                increment: substreams_ethereum::abi::read_uint(data, 32, "increment")?,
            })
        }
        pub fn encode(&self) -> Vec<u8> {
            let mut out: Vec<u8> = Vec::with_capacity(4 + 64usize);
    ...
    impl Initialize {
        ...
        pub fn decode(
            ...
            let data = maybe_data.unwrap();
            Ok(Self {
                token_name: substreams_ethereum::abi::read_string(
                    data,
                    0,
                    "token_name",
                )?,
                token_symbol: substreams_ethereum::abi::read_string(
                    data,
                    32,
                    "token_symbol",
                )?,
                token_currency: substreams_ethereum::abi::read_string(
                    data,
                    64,
                    "token_currency",
                )?,
                token_decimals: substreams_ethereum::abi::read_uint(
                    data,
                    96,
                    "token_decimals",
                )?,
                new_master_minter: substreams_ethereum::abi::read_address(
                    data,
                    128,
                    "new_master_minter",
                )?,
                new_pauser: substreams_ethereum::abi::read_address(
                    data,
                    160,
                    "new_pauser",
                )?,
                new_blacklister: substreams_ethereum::abi::read_address(
                    data,
                    192,
                    "new_blacklister",
                )?,
    ...
    impl InitializeV2 {
        ...
        pub fn decode(
            ...
            let data = maybe_data.unwrap();
            Ok(Self {
                new_name: substreams_ethereum::abi::read_string(data, 0, "new_name")?,
            })
        }
        pub fn encode(&self) -> Vec<u8> {
            let mut out: Vec<u8> = Vec::with_capacity(4 + 32usize);
    ...
    impl InitializeV21 {
        ...
        pub fn decode(
            ...
            let data = maybe_data.unwrap();
            Ok(Self {
                lost_and_found: substreams_ethereum::abi::read_address(
                    data,
                    0,
                    "lost_and_found",
                )?,
    ...
    impl Permit {
        ...
        pub fn decode(
            ...
            Ok(Self {
                owner: substreams_ethereum::abi::read_address(data, 0, "owner")?,
                spender: substreams_ethereum::abi::read_address(data, 32, "spender")?,
                value: substreams_ethereum::abi::read_uint(data, 64, "value")?,
                deadline: substreams_ethereum::abi::read_uint(data, 96, "deadline")?,
                v: substreams_ethereum::abi::read_uint(data, 128, "v")?,
                r: substreams_ethereum::abi::read_fixed_bytes::<32>(data, 160, "r")?,
                s: substreams_ethereum::abi::read_fixed_bytes::<32>(data, 192, "s")?,
            })
        }
        pub fn encode(&self) -> Vec<u8> {
            ...
            substreams_ethereum::abi::write_uint_at(&mut out, base + 64, &self.value);
            substreams_ethereum::abi::write_uint_at(&mut out, base + 96, &self.deadline);
            substreams_ethereum::abi::write_uint_at(&mut out, base + 128, &self.v);
            substreams_ethereum::abi::write_fixed_bytes_at(
                &mut out,
                base + 160,
                self.r.as_ref(),
    ...
    impl ReceiveWithAuthorization {
        ...
        pub fn decode(
            ...
            Ok(Self {
                ...
                value: substreams_ethereum::abi::read_uint(data, 64, "value")?,
                valid_after: substreams_ethereum::abi::read_uint(
                    data,
                    96,
                    "valid_after",
                )?,
                valid_before: substreams_ethereum::abi::read_uint(
                    data,
                    128,
                    "valid_before",
                )?,
                nonce: substreams_ethereum::abi::read_fixed_bytes::<
                    32,
                >(data, 160, "nonce")?,
                v: substreams_ethereum::abi::read_uint(data, 192, "v")?,
                r: substreams_ethereum::abi::read_fixed_bytes::<32>(data, 224, "r")?,
                s: substreams_ethereum::abi::read_fixed_bytes::<32>(data, 256, "s")?,
            })
        }
        pub fn encode(&self) -> Vec<u8> {
            ...
            substreams_ethereum::abi::write_uint_at(&mut out, base + 192, &self.v);
            substreams_ethereum::abi::write_fixed_bytes_at(
                &mut out,
                base + 224,
                self.r.as_ref(),
    ...
    impl RescueErc20 {
        ...
        pub fn decode(
            ...
            let data = maybe_data.unwrap();
            Ok(Self {
                token_contract: substreams_ethereum::abi::read_address(
                    data,
                    0,
                    "token_contract",
                )?,
    ...
    impl UpdateExchangeRate {
        ...
        pub fn decode(
            ...
            let data = maybe_data.unwrap();
            Ok(Self {
                new_exchange_rate: substreams_ethereum::abi::read_uint(
                    data,
                    0,
                    "new_exchange_rate",
                )?,
    ...
    impl UpdateOracle {
        ...
        pub fn decode(
            ...
            let data = maybe_data.unwrap();
            Ok(Self {
                new_oracle: substreams_ethereum::abi::read_address(
                    data,
                    0,
                    "new_oracle",
                )?,
    ...
    impl UpdateRescuer {
        ...
        pub fn decode(
            ...
            let data = maybe_data.unwrap();
            Ok(Self {
                new_rescuer: substreams_ethereum::abi::read_address(
                    data,
                    0,
                    "new_rescuer",
                )?,
...
pub mod events {
    ...
    impl Approval {
        ...
        pub fn decode<L: substreams_ethereum::LogLike>(log: &L) -> Result<Self, String> {
            ...
            Ok(Self {
                ...
                spender: substreams_ethereum::abi::read_address(
    ...
    impl AuthorizationCanceled {
        ...
        pub fn decode<L: substreams_ethereum::LogLike>(log: &L) -> Result<Self, String> {
            ...
            Ok(Self {
                ...
                nonce: substreams_ethereum::abi::read_fixed_bytes::<
                    32,
                >(log.topic(2usize).expect("bounds already checked"), 0, "nonce")?,
            })
        }
    }
    ...
    impl Burn {
        ...
        pub fn decode<L: substreams_ethereum::LogLike>(log: &L) -> Result<Self, String> {
            ...
            Ok(Self {
                burner: substreams_ethereum::abi::read_address(
                    log.topic(1usize).expect("bounds already checked"),
                    0,
                    "burner",
                )?,
    ...
    impl ExchangeRateUpdated {
        ...
        pub fn decode<L: substreams_ethereum::LogLike>(log: &L) -> Result<Self, String> {
            ...
            Ok(Self {
                oracle: substreams_ethereum::abi::read_address(
                    log.topic(1usize).expect("bounds already checked"),
                    0,
                    "oracle",
                )?,
    ...
    impl MinterRemoved {
        ...
        pub fn decode<L: substreams_ethereum::LogLike>(log: &L) -> Result<Self, String> {
            ...
            Ok(Self {
                old_minter: substreams_ethereum::abi::read_address(
                    log.topic(1usize).expect("bounds already checked"),
                    0,
                    "old_minter",
                )?,
