...
/** Lazy view of `amphor.types.v1.Events`: nested and repeated message fields are
...
pub struct EventsLazyView<'a> {
    ...
    pub lrt_vault_deposits: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::LrtVaultDepositLazyView<'a>,
    >,
    /// Field 2: `lrt_vault_withdraws`
    pub lrt_vault_withdraws: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::LrtVaultWithdrawLazyView<'a>,
    >,
}
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                1u32 => {
                    ...
                    view.lrt_vault_deposits.push_bytes(sub, __sub_ctx);
                }
                2u32 => {
                    ::buffa::encoding::check_wire_type(
                        tag,
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    ctx.register_element_memory(::core::mem::size_of::<&'a [u8]>())?;
                    view.lrt_vault_withdraws.push_bytes(sub, __sub_ctx);
                }
                _ => {
        ...
        ::core::result::Result::Ok(super::super::Events {
            lrt_vault_deposits: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.lrt_vault_deposits.len(),
                );
                for __r in self.lrt_vault_deposits.iter() {
            ...
            lrt_vault_withdraws: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.lrt_vault_withdraws.len(),
                );
                for __r in self.lrt_vault_withdraws.iter() {
                    __out.push(__r?.to_owned_message()?);
                }
                __out
            },
...
impl<'a> EventsLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        let mut size = 0u64;
        for __frag in self.lrt_vault_deposits.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
        for __frag in self.lrt_vault_withdraws.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
...
/** Lazy view of `amphor.types.v1.LrtVaultDeposit`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `LrtVaultDepositView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `LrtVaultDepositView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = LrtVaultDepositLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct LrtVaultDepositLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `sender`
    pub sender: &'a str,
...
impl<'a> LrtVaultDepositLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for LrtVaultDepositLazyView<'a> {
...
impl<'a> ::buffa::MessageName for LrtVaultDepositLazyView<'a> {
    const PACKAGE: &'static str = "amphor.types.v1";
...
/** Lazy view of `amphor.types.v1.LrtVaultWithdraw`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `LrtVaultWithdrawView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `LrtVaultWithdrawView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = LrtVaultWithdrawLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct LrtVaultWithdrawLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `sender`
    pub sender: &'a str,
...
impl<'a> LrtVaultWithdrawLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for LrtVaultWithdrawLazyView<'a> {
...
impl<'a> ::buffa::MessageName for LrtVaultWithdrawLazyView<'a> {
    const PACKAGE: &'static str = "amphor.types.v1";
