...
/** Lazy view of `usual.types.v1.Events`: nested and repeated message fields are
...
pub struct EventsLazyView<'a> {
    ...
    pub usyc_transfers: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::UsycTransferLazyView<'a>,
    >,
    /// Field 2: `usyc_fee_processeds`
    pub usyc_fee_processeds: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::UsycFeeProcessedLazyView<'a>,
    >,
}
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                1u32 => {
                    ...
                    view.usyc_transfers.push_bytes(sub, __sub_ctx);
                }
                2u32 => {
                    ::buffa::encoding::check_wire_type(
                        tag,
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    ctx.register_element_memory(::core::mem::size_of::<&'a [u8]>())?;
                    view.usyc_fee_processeds.push_bytes(sub, __sub_ctx);
                }
                _ => {
        ...
        ::core::result::Result::Ok(super::super::Events {
            usyc_transfers: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.usyc_transfers.len(),
                );
                for __r in self.usyc_transfers.iter() {
            ...
            usyc_fee_processeds: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.usyc_fee_processeds.len(),
                );
                for __r in self.usyc_fee_processeds.iter() {
                    __out.push(__r?.to_owned_message()?);
                }
                __out
            },
...
impl<'a> EventsLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        let mut size = 0u64;
        for __frag in self.usyc_transfers.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
        for __frag in self.usyc_fee_processeds.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
...
/** Lazy view of `usual.types.v1.UsycTransfer`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `UsycTransferView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `UsycTransferView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = UsycTransferLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct UsycTransferLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `from`
    pub from: &'a str,
...
impl<'a> ::buffa::LazyMessageView<'a> for UsycTransferLazyView<'a> {
...
impl<'a> ::buffa::MessageName for UsycTransferLazyView<'a> {
    const PACKAGE: &'static str = "usual.types.v1";
...
/** Lazy view of `usual.types.v1.UsycFeeProcessed`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `UsycFeeProcessedView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `UsycFeeProcessedView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = UsycFeeProcessedLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct UsycFeeProcessedLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `recipient`
    pub recipient: &'a str,
...
impl<'a> UsycFeeProcessedLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for UsycFeeProcessedLazyView<'a> {
...
impl<'a> ::buffa::MessageName for UsycFeeProcessedLazyView<'a> {
    const PACKAGE: &'static str = "usual.types.v1";
