...
use crate::pb::liquity::types::v1::{
    ActivePoolEthBalanceUpdated, ActivePoolLusdDebtUpdated, CollBalanceUpdated, EthGainWithdrawn, Events,
    LastGoodPriceUpdated, Liquidation, LusdBorrowingFeePaid, Redemption, StabilityPoolEthBalanceUpdated,
    StabilityPoolLusdBalanceUpdated, TroveLiquidated, TroveUpdated, UserDepositChanged,
};

const TROVE_MANAGER: [u8; 20] = hex_literal::hex!("a39739ef8b0231dbfa0dcda07d7e29faabcf4bb2");
const BORROWER_OPERATIONS: [u8; 20] = hex_literal::hex!("24179cd81c9e782a4096035f7ec97fb8b783e007");
...
const COLL_SURPLUS_POOL: [u8; 20] = hex_literal::hex!("3d32e8b97ed5881324241cf03b2da5e2ebce5521");
