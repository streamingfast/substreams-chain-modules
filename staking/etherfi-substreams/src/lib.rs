...
use crate::pb::etherfi::types::v1::{
    Deposit, EarlyDeposit, EarlyWithdrawn, Events, FullWithdrawal, FundsClaimed, NodeEvicted, NodeExitProcessed,
    NodeExitRequested, PartialWithdrawal, Rebase, ValidatorApproved, ValidatorRegistered, Withdraw,
};

const EARLY_ADOPTER_POOL: [u8; 20] = hex_literal::hex!("7623e9dc0da6ff821ddb9ebaba794054e078f8c4");

const LIQUIDITY_POOL: [u8; 20] = hex_literal::hex!("308861a430be4cce5502d0a12724771fc6daf216");
