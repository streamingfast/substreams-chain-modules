...
/** Lazy view of `klimadao.types.v1.Events`: nested and repeated message fields are
...
pub struct EventsLazyView<'a> {
    ...
    pub bct_transfers: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::BctTransferLazyView<'a>,
    >,
    /// Field 2: `bct_redeem_fee_paids`
    pub bct_redeem_fee_paids: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::BctRedeemFeePaidLazyView<'a>,
    >,
}
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                1u32 => {
                    ...
                    view.bct_transfers.push_bytes(sub, __sub_ctx);
                }
                2u32 => {
                    ::buffa::encoding::check_wire_type(
                        tag,
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    ctx.register_element_memory(::core::mem::size_of::<&'a [u8]>())?;
                    view.bct_redeem_fee_paids.push_bytes(sub, __sub_ctx);
                }
                _ => {
        ...
        ::core::result::Result::Ok(super::super::Events {
            bct_transfers: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.bct_transfers.len(),
                );
                for __r in self.bct_transfers.iter() {
            ...
            bct_redeem_fee_paids: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.bct_redeem_fee_paids.len(),
                );
                for __r in self.bct_redeem_fee_paids.iter() {
                    __out.push(__r?.to_owned_message()?);
                }
                __out
            },
...
impl<'a> EventsLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        let mut size = 0u64;
        for __frag in self.bct_transfers.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
        for __frag in self.bct_redeem_fee_paids.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
...
/** Lazy view of `klimadao.types.v1.BctTransfer`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `BctTransferView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `BctTransferView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = BctTransferLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct BctTransferLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `from`
    pub from: &'a str,
...
impl<'a> ::buffa::LazyMessageView<'a> for BctTransferLazyView<'a> {
...
impl<'a> ::buffa::MessageName for BctTransferLazyView<'a> {
    const PACKAGE: &'static str = "klimadao.types.v1";
...
/** Lazy view of `klimadao.types.v1.BctRedeemFeePaid`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `BctRedeemFeePaidView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `BctRedeemFeePaidView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = BctRedeemFeePaidLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct BctRedeemFeePaidLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `redeemer`
    pub redeemer: &'a str,
...
impl<'a> BctRedeemFeePaidLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for BctRedeemFeePaidLazyView<'a> {
...
impl<'a> ::buffa::MessageName for BctRedeemFeePaidLazyView<'a> {
    const PACKAGE: &'static str = "klimadao.types.v1";
