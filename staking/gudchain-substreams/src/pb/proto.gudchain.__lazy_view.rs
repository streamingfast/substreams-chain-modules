...
/** Lazy view of `gudchain.types.v1.Events`: nested and repeated message fields are
...
pub struct EventsLazyView<'a> {
    ...
    pub vault_v1_deposits: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::VaultV1DepositLazyView<'a>,
    >,
    /// Field 2: `vault_v1_withdraws`
    pub vault_v1_withdraws: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::VaultV1WithdrawLazyView<'a>,
    >,
}
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                1u32 => {
                    ...
                    view.vault_v1_deposits.push_bytes(sub, __sub_ctx);
                }
                2u32 => {
                    ::buffa::encoding::check_wire_type(
                        tag,
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    ctx.register_element_memory(::core::mem::size_of::<&'a [u8]>())?;
                    view.vault_v1_withdraws.push_bytes(sub, __sub_ctx);
                }
                _ => {
        ...
        ::core::result::Result::Ok(super::super::Events {
            vault_v1_deposits: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.vault_v1_deposits.len(),
                );
                for __r in self.vault_v1_deposits.iter() {
            ...
            vault_v1_withdraws: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.vault_v1_withdraws.len(),
                );
                for __r in self.vault_v1_withdraws.iter() {
                    __out.push(__r?.to_owned_message()?);
                }
                __out
            },
...
impl<'a> EventsLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        let mut size = 0u64;
        for __frag in self.vault_v1_deposits.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
        for __frag in self.vault_v1_withdraws.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
...
/** Lazy view of `gudchain.types.v1.VaultV1Deposit`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `VaultV1DepositView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `VaultV1DepositView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = VaultV1DepositLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct VaultV1DepositLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `token`
    pub token: &'a str,
...
impl<'a> VaultV1DepositLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for VaultV1DepositLazyView<'a> {
...
impl<'a> ::buffa::MessageName for VaultV1DepositLazyView<'a> {
    const PACKAGE: &'static str = "gudchain.types.v1";
...
/** Lazy view of `gudchain.types.v1.VaultV1Withdraw`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `VaultV1WithdrawView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `VaultV1WithdrawView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = VaultV1WithdrawLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct VaultV1WithdrawLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `token`
    pub token: &'a str,
...
impl<'a> VaultV1WithdrawLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for VaultV1WithdrawLazyView<'a> {
...
impl<'a> ::buffa::MessageName for VaultV1WithdrawLazyView<'a> {
    const PACKAGE: &'static str = "gudchain.types.v1";
