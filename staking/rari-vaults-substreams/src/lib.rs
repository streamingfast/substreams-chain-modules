...
use crate::pb::rari_vaults::types::v1::{
    Events, RariDaiFundManagerDeposit, RariDaiFundManagerWithdrawal, RariEtherFundManagerDeposit,
    RariEtherFundManagerWithdrawal, RariUsdcFundManagerDeposit, RariUsdcFundManagerWithdrawal,
    RariYieldFundManagerDeposit, RariYieldFundManagerWithdrawal,
};
