...
/** Lazy view of `superseed.types.v1.Events`: nested and repeated message fields are
...
pub struct EventsLazyView<'a> {
    ...
    pub super_sale_deposit_tokens_purchases: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::SuperSaleDepositTokensPurchaseLazyView<'a>,
    >,
}
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                1u32 => {
                    ...
                    view.super_sale_deposit_tokens_purchases.push_bytes(sub, __sub_ctx);
                }
                _ => {
        ...
        ::core::result::Result::Ok(super::super::Events {
            super_sale_deposit_tokens_purchases: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.super_sale_deposit_tokens_purchases.len(),
                );
                for __r in self.super_sale_deposit_tokens_purchases.iter() {
...
impl<'a> EventsLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        let mut size = 0u64;
        for __frag in self.super_sale_deposit_tokens_purchases.raw_elements() {
            size
...
/** Lazy view of `superseed.types.v1.SuperSaleDepositTokensPurchase`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `SuperSaleDepositTokensPurchaseView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `SuperSaleDepositTokensPurchaseView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = SuperSaleDepositTokensPurchaseLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct SuperSaleDepositTokensPurchaseLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `user`
    pub user: &'a str,
...
impl<'a> SuperSaleDepositTokensPurchaseLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for SuperSaleDepositTokensPurchaseLazyView<'a> {
...
impl<'a> ::buffa::MessageName for SuperSaleDepositTokensPurchaseLazyView<'a> {
    const PACKAGE: &'static str = "superseed.types.v1";
