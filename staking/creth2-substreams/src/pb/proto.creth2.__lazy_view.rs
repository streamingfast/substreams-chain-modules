...
/** Lazy view of `creth2.types.v1.Events`: nested and repeated message fields are
...
pub struct EventsLazyView<'a> {
    ...
    pub cream_transfers: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::CreamTransferLazyView<'a>,
    >,
    /// Field 2: `creth_transfers`
    pub creth_transfers: ::buffa::LazyRepeatedView<
        'a,
        super::super::__buffa::lazy_view::CrethTransferLazyView<'a>,
    >,
}
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                1u32 => {
                    ...
                    view.cream_transfers.push_bytes(sub, __sub_ctx);
                }
                2u32 => {
                    ::buffa::encoding::check_wire_type(
                        tag,
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    ctx.register_element_memory(::core::mem::size_of::<&'a [u8]>())?;
                    view.creth_transfers.push_bytes(sub, __sub_ctx);
                }
                _ => {
        ...
        ::core::result::Result::Ok(super::super::Events {
            cream_transfers: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.cream_transfers.len(),
                );
                for __r in self.cream_transfers.iter() {
            ...
            creth_transfers: {
                let mut __out = ::buffa::alloc::vec::Vec::with_capacity(
                    self.creth_transfers.len(),
                );
                for __r in self.creth_transfers.iter() {
                    __out.push(__r?.to_owned_message()?);
                }
                __out
            },
...
impl<'a> EventsLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        let mut size = 0u64;
        for __frag in self.cream_transfers.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
        for __frag in self.creth_transfers.raw_elements() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
...
/** Lazy view of `creth2.types.v1.CreamTransfer`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `CreamTransferView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `CreamTransferView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = CreamTransferLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct CreamTransferLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `from`
    pub from: &'a str,
...
impl<'a> CreamTransferLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for CreamTransferLazyView<'a> {
...
impl<'a> ::buffa::MessageName for CreamTransferLazyView<'a> {
    const PACKAGE: &'static str = "creth2.types.v1";
...
/** Lazy view of `creth2.types.v1.CrethTransfer`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `CrethTransferView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `CrethTransferView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = CrethTransferLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct CrethTransferLazyView<'a> {
    /// Field 1: `id`
    pub id: &'a str,
    /// Field 2: `from`
    pub from: &'a str,
...
impl<'a> CrethTransferLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for CrethTransferLazyView<'a> {
...
impl<'a> ::buffa::MessageName for CrethTransferLazyView<'a> {
    const PACKAGE: &'static str = "creth2.types.v1";
